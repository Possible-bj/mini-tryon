...
def test_with_custom_images():
    ...
    human_img_path = "example/human/2023-TB.jpeg"  # Change this to your human image path
    garment_img_path = "example/cloth/04469_00.jpg"  # Change this to your garment image path
